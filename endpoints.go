 ...
 *     http://wanderinglunch.com/api/markers?updated_since=8
 ...
 * @apiGroup Images
 * @apiExample {GET} Example usage:
 *     http://wanderinglunch.com/api/images
 * @apiSuccessExample {json} Success-Response:
 * [
 *  {
 ...
 * @apiExample {GET} Example usage:
 *     http://wanderinglunch.com/api/images/4dfa4a9840a3542ff44549df
 * @apiSuccessExample {json} Success-Response:
 * {
 ...
 * @apiUse Message
 * @apiExample {GET} Example usage:
 *     http://wanderinglunch.com/api/messages?amount=1
 * @apiSuccessExample {json} Success-Response:
 * {
 *   "id": 0,
...
/**
 * @api {get} /ads List Ads
 * @apiName GetAds
 * @apiDescription Ads that have run on the site
 * @apiVersion 1.0.0
 * @apiGroup Ads
 * @apiUse Ad
 * @apiExample {GET} Example usage:
 *     http://wanderinglunch.com/api/ads
 * @apiSuccessExample {json} Success-Response:
 * [
 *   {
 *      "id": 16,
...
/**
 * @api {delete} /ads/:id Delete an ad
 * @apiName DeleteAd
 * @apiVersion 1.0.0
 * @apiParam {Number} id Id of the ad to delete
 * @apiGroup Ads
 */
...
/**
 * @api {post} /ads Create a new ad
 * @apiName NewAd
 * @apiDescription Save a new ad
 * @apiVersion 1.0.0
 * @apiUse Ad
 * @apiGroup Ads
 */
...
/**
 * @api {put} /ads/:id Update an ad
 * @apiName UpdateAd
 * @apiDescription Update an ad
 * @apiVersion 1.0.0
 * @apiParam {Number} id Id of the ad to update
 * @apiUse Ad
 * @apiGroup Ads
 */
 ...
 * @apiName GetAd
 * @apiDescription Get an ad by id
 * @apiVersion 1.0.0
 * @apiParam {Number} id Autogenerated id of the ad
 * @apiGroup Ads
 * @apiUse Ad
 * @apiExample {GET} Example usage:
 *     http://wanderinglunch.com/api/ad/16
 * @apiSuccessExample {json} Success-Response:
 * {
 *   "id":16,
 *   "name":"her23aa",
